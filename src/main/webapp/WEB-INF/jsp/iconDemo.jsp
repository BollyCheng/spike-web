...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<spring:url value="/resources/css/demo/demo.css" />"/>
	<script src="<spring:url value="/resources/js/demo/demo.js" />"></script>
	<script src="<spring:url value="/resources/js/demo/liga.js" />"></script>
